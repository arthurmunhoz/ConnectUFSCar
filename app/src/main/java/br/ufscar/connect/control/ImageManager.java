package br.ufscar.connect.control;
...
/**
 * Created by Arthur on 23/02/2017.
 */
                ...
                while(true) {
                    ...
                    if(imageQueue.imageRefs.size() != 0) {
                        ...
                        if(tag != null && ((String)tag).equals(imageToLoad.url)) {
                            com.nostra13.universalimageloader.core.display.BitmapDisplayer bmpDisplayer =
                                    new com.nostra13.universalimageloader.core.display.BitmapDisplayer() {
                                        @Override
                            ...
                            a.runOnUiThread((Runnable) bmpDisplayer);
                        }
                    }
